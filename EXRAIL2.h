...
enum OPCODE : byte {OPCODE_THROW,OPCODE_CLOSE,OPCODE_TOGGLE_TURNOUT,
             OPCODE_FWD,OPCODE_REV,OPCODE_SPEED,OPCODE_SPEEDUP,OPCODE_SLOWDOWN,OPCODE_SPEEDUP_REL,OPCODE_SLOWDOWN_REL,OPCODE_INVERT_DIRECTION,OPCODE_SAVESPEED,OPCODE_RESTORESPEED,
             OPCODE_MOMENTUM,
	     ...
	     OPCODE_ONRAILSYNCON,OPCODE_ONRAILSYNCOFF,
            ...
            IF_TYPE_OPCODES, // do not move this... 
             ...
             OPCODE_IFRANDOM,OPCODE_IFRESERVE,OPCODE_IFRESERVED,
