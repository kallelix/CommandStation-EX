...
#define IFRESERVED(block) OPCODE_IFRESERVED,V(block),
...
#define START_LOCO_S(route) OPCODE_START_LOCO_S,V(route),
#define START_LOCO_X(route) OPCODE_START_LOCO_X,V(route),
